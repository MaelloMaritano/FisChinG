...
class Camera
{
	...
	public:
		...
		void testState(CameraState new_state) {setState(new_state);} // just for testing versions
	private:
...
int main()
{
	...
	Fish* fish=scene.addEntity<Fish>("fish", glm::vec3(0.0f, 0.4f, -2.5f), glm::vec3(0.0f, 90.0f, 0.0f), false); // here just for testing
